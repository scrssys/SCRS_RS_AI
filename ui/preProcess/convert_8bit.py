...
class Ui_Dialog_convert8bit(object):
    ...
    def retranslateUi(self, Dialog_convert8bit):
        ...
        self.label_5.setText(_translate("Dialog_convert8bit", "block"))
