...
class child_convert_8bit(QDialog,Ui_Dialog_convert8bit):
    ...
    def slot_ok(self):
        dir_sample = self.lineEdit_imagpath.text()
        ...
        try:
            ...
            batch_convert_8bit(dir_sample,dir_output)
        except:
            QMessageBox.information(self, '分割失败', "Error occurred")
            pass
        # cmd = ['python',r'D:\coding\SCRS_RS_AI-developer_0311\data_prepare\convert_to_8bits.py',"batch_convert_8bit",dir_sample,dir_output]
        # try:
        #     subprocess.call(cmd)
        # except:
