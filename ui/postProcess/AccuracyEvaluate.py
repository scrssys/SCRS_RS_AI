...
class Ui_Dialog_accuracy_evaluate(object):
    def setupUi(self, Dialog_accuracy_evaluate):
        ...
        self.layoutWidget = QtWidgets.QWidget(Dialog_accuracy_evaluate)
        self.layoutWidget.setGeometry(QtCore.QRect(13, 13, 404, 216))
        ...
        self.lineEdit_gt = QtWidgets.QLineEdit(self.layoutWidget)
        ...
        self.pushButton_gt = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.spinBox_max.setProperty("value", 1)
